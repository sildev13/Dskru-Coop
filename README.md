...
- ใช้ลูกศรกับแป้นบนจอได้: **↓ จากช่องรหัส** เข้าแป้น, **↑ ↓ ← →** เลือกปุ่มที่มีกรอบสีส้ม, **Enter** ใส่เลขโดยยังเลือกปุ่มเดิม, **↑ จากแถวบน** กลับช่องรหัส และ **↓ จากแถวล่าง** ไปปุ่มยืนยันเมื่อพร้อมชำระ **↑ จากช่องรหัสหรือปุ่มยืนยัน** เลือกปุ่ม **×**, กด **Enter** เพื่อปิด หรือ **↓ / ← จาก ×** กลับช่องรหัส ปุ่มลบ/ล้างที่ใช้ไม่ได้จะถูกข้าม ช่องรหัสยังใช้ ← → เลื่อนเคอร์เซอร์และพิมพ์เลขจาก Numpad ได้ตามปกติ ปิดด้วย Escape ได้ก่อนสร้างรายการเช่นเดิม
